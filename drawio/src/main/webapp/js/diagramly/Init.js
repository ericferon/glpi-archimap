...
window.SHAPES_PATH = window.SHAPES_PATH || '../drawio/src/main/webapp/shapes';
// Path for images inside the diagram
window.GRAPH_IMAGE_PATH = window.GRAPH_IMAGE_PATH || '../drawio/src/main/webapp/img';
...
window.TEMPLATE_PATH = window.TEMPLATE_PATH || '../drawio/src/main/webapp/templates';

// Directory for i18 files and basename for main i18n file
window.RESOURCES_PATH = window.RESOURCES_PATH || '../drawio/src/main/webapp/resources';
...
// the special bundle.
// Added EFE 20180321
window.mxBasePath = '../drawio/src/main/webapp/mxgraph';
