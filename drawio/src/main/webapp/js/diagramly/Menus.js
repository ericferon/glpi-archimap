...
// Changed EFE 20170716
		//		if (urlParams['embed'] == '1')
		if (urlParams['embed'] == '1' || urlParams['glpi'] == '1')
// End of Changed EFE 20170716
		{
...
// Added by EFE 20170716 : with autocomplete, the window.parent has changed; set the parent to the top window
				if (urlParams['glpi'] == 1)
					parent = window.top;
// End of Added by EFE 20170716
...
=======
					if (urlParams['dev']) log.debug('save diagram ' + diagramid.value + ' on ' + new Date());
>>>>>>> ef7aa160ff4b6d06950afcfcbe3025dc57a43397
					if (diagramid) {
...
=======
						if (urlParams['dev']) log.debug(' - before : ' + inputgraph.value.length + ' - after : ' + data.length+'\n - before : ' + inputgraph.value + '\n - after : ' + data + '\n');
>>>>>>> ef7aa160ff4b6d06950afcfcbe3025dc57a43397
...
//				this.addMenuItems(menu, ['-', 'close']);
				this.addMenuItems(menu, ['-', 'preferences', 'exit']);
// End of Added EFE 20180321
			}
		})));
	};
