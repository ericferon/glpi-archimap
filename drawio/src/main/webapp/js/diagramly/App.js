...
// Added EFE 20200526 : allow "untrusted" plugins
//						Editor.configure(data.config, true);
						Editor.configure(data.config, false);
                        window.config = data.config; // keep config
// End of Added EFE 20200526 : allow "untrusted" plugins
						mxSettings.load();
						doMain();
					}
				}
